                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            ...
                            <div class="p-2 w-full mt-4 flex justify-around">
                                {{-- 戻るボタンは postメソッドしないので type="button" をつけておく --}}
                                  <button type="button" onclick="location.href='{{ route('owner.shops.index') }}'" class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">
                                    戻る
                                  </button>
